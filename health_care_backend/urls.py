...
urlpatterns = [
    ...
    path('my_user/<int:user_id>', api_get_my_user_view),
    path('my_user/<int:user_id>/delete', api_delete_my_user_view),
    path('my_user/<int:user_id>/update', api_update_my_user_view),
